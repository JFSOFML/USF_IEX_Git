...
#     | {review_2}| Postive  | NEGATIVE | Negative/0 |
#     | {review_3}| Negative | NEGATIVE | Negative/0 |
#     | {review_4}| Positive | POSITIVE | Positive/1 |
#     | {review_5}| Positive | POSITIVE | Positive/1 |
#     """)
#     st.divider()
if selection == 'Model Comparison':
    ...
    data = {
        ...
        "SVC Model Prediction": ["Negative", "Positive", "Negative", "Positive", "Positive"],
        "LLM Prediction": ["NEGATIVE", "NEGATIVE", "NEGATIVE", "POSITIVE", "POSITIVE"],
        "Actual Value": ["Negative/0", "Negative/0", "Negative/0", "Positive/1", "Positive/1"]
    }
...
However, I could not run the entire dataset through the LLM because of the limitations of my device. It would take approximately 625 Hours to run sentitment analysis with LLM Studios on the entire dataset.

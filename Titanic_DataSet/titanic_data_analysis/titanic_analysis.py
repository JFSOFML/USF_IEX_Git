"""Titanic Data Analytics, who lived or died and why"""
...
sns.barplot(
    x=survival_rate_gender.index, y=survival_rate_gender.values, palette="coolwarm"
)
...
sns.barplot(
    x=survival_rate_class.index, y=survival_rate_class.values, palette="viridis"
)
...
sns.barplot(
    x=survival_rate_age_group.index, y=survival_rate_age_group.values, palette="pastel"
)
